...
//
//
// static salloc_obj_t slist_node_salloc_obj;
//
//
// void init_slist()
// {
//     salloc_create(&slist_node_salloc_obj, sizeof(slist_node_t), 0, 0, NULL, NULL);
// }
//
...
// }
//
// void slist_insert_at(slist_t *l, slist_node_t *prev, void *n)
// {
//     panic_if(!spinlock_is_locked(&l->lock), "slist must be locked!\n");
//
//     slist_node_t *s = salloc(&slist_node_salloc_obj);
//     assert(s);
//     s->node = n;
//
//     if (prev) {
...
// }
//
// static void slist_remove(slist_t *l, slist_node_t *prev, slist_node_t *s)
// {
//     panic_if(!spinlock_is_locked(&l->lock), "slist must be locked!\n");
//     if (!s) {
//         return;
...
// }
//
// void *slist_remove_item(slist_t *l, void *n)
// {
//     panic_if(!spinlock_is_locked(&l->lock), "slist must be locked!\n");
//     if (!n) {
//         return NULL;
...
// }
//
// void *slist_remove_item_exclusive(slist_t *l, void *n)
// {
//     spinlock_lock_int(&l->lock);
//     void *ret = slist_remove_item(l, n);
