...
//  * Token handling
//  */
// #define print_token_ll(s, arg, len)                 \
//     do {                                            \
//         char token = *s;                            \
//         u64 va_u64 = 0;                             \
//                                                     \
...
//     } while (0)
//
// #define print_token_l(s, arg, len)                  \
//     do {                                            \
//         char token = *s;                            \
//         ulong va_ulong = 0;                         \
//                                                     \
